...
if Desk_in_first_class % 1 < 0.1:
    Desk_in_first_class += 1

if Desk_in_second_class % 1 < 0.1:
    Desk_in_second_class += 1

if Desk_in_third_class % 1 < 0.1:
    Desk_in_third_class += 1

print("First class requires " + str(Desk_in_first_class) + " desk")
print("Second class requires " + str(Desk_in_second_class) + " desk")
print("Third class requires " + str(Desk_in_third_class) + " desk")
